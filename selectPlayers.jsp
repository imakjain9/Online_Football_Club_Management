...
<form action="playerPerformance.jsp" method="post">
<div id="content">
    <table class="table">
        <thread>
        <tr>
...
System.out.println("working here gefe");
    ...
    while(rs1.next())
    {
            out.println("<tr><td>"+rs1.getString("username")+"</td><td>"+rs1.getString("name")+"</td><td>"+rs1.getDate("dob")+"</td><td>"+rs1.getString("experience")+"</td><td>"+rs1.getLong("mobile")+"</td><td>"+rs1.getString("city")+"</td><td>"+rs1.getString("state")+"</td><td><input type='checkbox' name='selectedPlayers' value='"+rs1.getString("email")+"'/></td></tr>");
    }
} 
}catch(Exception e){
...
<div class="form-group"> 
    <div class="col-sm-6" style="padding-left:400px">
        <input type="submit" class="button" value="Add Players"/>
