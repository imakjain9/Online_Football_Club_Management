...
<h2><center>New Claim</center></h2><br/>
<form id="SalInc" role="form" class="form-horizontal" action="UserController?id=newclaim" onsubmit="return validateForm()" method="post">  
<fieldset>
    <legend style="color:white;">Enter Claim Details</legend>
...
window.onload = function() {
  document.getElementById('datePicker').valueAsDate = new Date();
    ...
    <div style="padding-left:250px;" class="form-group">
        ...
        <div  class="col-sm-3">
           <input id="datePicker" type="date" class="form-control" name="claimdate" readonly>
        </div>
    </div>
    <div style="padding-left:250px;" class="form-group">
        <label class="control-label col-sm-3" style="color:white;">Choose Claim Type:</label>
        <div class="col-sm-3">
            <select  class="form-control" name="claimtype" required>
                <option setselected="true" value="">claim type</option>
                <option  value="TA">Travel Allownace</option>
    ...
    <div style="padding-left:250px;" class="form-group">
        ...
        <div class="col-sm-3">
           <input type="number" class="form-control" placeholder="Enter amount" name="claimamount" required>
        </div>
    </div>
